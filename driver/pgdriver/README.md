...
[![PkgGoDev](https://pkg.go.dev/badge/github.com/sword0307/bun/driver/pgdriver)](https://pkg.go.dev/github.com/sword0307/bun/driver/pgdriver)
...
```shell
go get github.com/sword0307/bun/driver/pgdriver
```

And then create a `sql.DB` using it:

```go
import _ "github.com/sword0307/bun/driver/pgdriver"
