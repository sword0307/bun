...
[![PkgGoDev](https://pkg.go.dev/badge/github.com/sword0307/bun/driver/sqliteshim)](https://pkg.go.dev/github.com/sword0307/bun/driver/sqliteshim)
...
```shell
go get github.com/sword0307/bun/driver/sqliteshim
```
